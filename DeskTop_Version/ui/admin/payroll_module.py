...
class PayrollModule(QWidget):
    ...
    def init_ui(self):
        ...
        # Controls
        header = QHBoxLayout()
        header.addWidget(QLabel("<h2>Payroll Processing</h2>"))
        ...
        self.table.setHorizontalHeaderLabels([
            "Employee", "Base Salary", "Present Days", "Late Ded.", "Short Lv Ded.", "OT Pay", "Hol. OT", "Net Salary", "Status"
        ])
        ...
        if file_path:
            try:
                with open(file_path, 'w', newline='') as f:
                    writer = csv.writer(f)
                    # Header
                    writer.writerow(["Employee", "Base Salary", "Present Days", "Late Ded.", "Short Lv Ded.", "OT Pay", "Hol. OT Pay", "Net Salary"])
